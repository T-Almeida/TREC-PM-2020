...
CODE FROM URL: https://github.com/castorini/anserini/blob/master/src/main/python/fusion.py
"""
...
def perform_fusion(method: FusionMethod, runs: List[TrecRun], output_path: str) -> None:
    ...
    if method == FusionMethod.RRF:
        ...
        raise Exception("The requested method", method ,"is not implemented.")
...
if __name__ == "__main__":
    ...
    print("Fusion successful ->" ,args.out)